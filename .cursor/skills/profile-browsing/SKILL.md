...
Read the profiler subagent definition at `.cursor/agents/profiler.md`. Then spawn one `profiler` subagent per batch in parallel using Cursor's current delegation tool.
