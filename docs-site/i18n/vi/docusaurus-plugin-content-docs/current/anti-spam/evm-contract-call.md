...
Đối với các cộng đồng không dựa vào danh tính trên chuỗi, thay vào đó hãy xem xét [Chế chặn thư rác](./spam-blocker.md) hoặc [Thử bội chứng từ](./voucher-challenge.md).
