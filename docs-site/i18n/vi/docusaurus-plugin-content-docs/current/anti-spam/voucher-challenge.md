...
Bởi vì nó yêu cầu phân phối mã thủ công nên nó không mở rộng ra các cộng đồng mở lớn. Đối với những trường hợp đó, hãy xem xét [Dứt chặn thư rác](./spam-blocker.md) hoặc [Thử cuộc gọi hợp đồng EVM](./evm-contract-call.md) thay thế.
