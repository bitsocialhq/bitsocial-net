...
Các hook được tổ chức thành các loại chức năng. Dưới đây là bản tóm tắt các hook được sử dụng phổ biến nhất trong mỗi danh mục. Để biết đầy đủ về chữ ký, tham số và kiểu trả về, hãy xem [tài liệu tham khảo API đầy đủ trên GitHub](https://github.com/bitsocialnet/bitsocial-react-hooks).
...
- **GitHub:** [bitsocialnet/bitsocial-Reac-hooks](https://github.com/bitsocialnet/bitsocial-react-hooks)
