...
description: كيف تستخدم Bitsocial عنونة المفتاح العام وPubsub من نظير إلى نظير لتقديم وسائط اجتماعية بدون خادم.
---
...
## مستخدمي المتصفح والبوابات

لا يمكن للمتصفحات الانضمام إلى شبكات نظير إلى نظير مباشرةً. يتعامل Bitsocial مع هذا من خلال **بوابات HTTP** التي تنقل البيانات بين شبكة P2P وعملاء المتصفح. هذه البوابات:
...
وهذا يحافظ على سلاسة تجربة المتصفح مع الحفاظ على البنية اللامركزية الموجودة تحتها.
