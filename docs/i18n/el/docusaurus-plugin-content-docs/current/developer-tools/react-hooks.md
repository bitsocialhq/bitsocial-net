...
Αυτή η βιβλιοθήκη είναι η κύρια διεπαφή που χρησιμοποιείται από το [5καν](/apps/5chan/) και άλλες εφαρμογές πελάτη Bitsocial.
...
Τα άγκιστρα είναι οργανωμένα σε λειτουργικές κατηγορίες. Παρακάτω είναι μια σύνοψη των πιο συχνά χρησιμοποιούμενων γάντζων σε κάθε κατηγορία. Για πλήρεις υπογραφές, παραμέτρους και τύπους επιστροφής, δείτε το [πλήρης αναφοράς API στο GitHub](https://github.com/bitsocialnet/bitsocial-react-hooks).
