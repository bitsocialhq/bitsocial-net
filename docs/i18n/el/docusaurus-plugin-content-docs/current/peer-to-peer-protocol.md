...
description: Πώς το Bitsocial χρησιμοποιεί διευθύνσεις δημόσιου κλειδιού και pubsub peer-to-peer για να προσφέρει μέσα κοινωνικής δικτύωσης χωρίς διακομιστές.
---
...
## Χρήστες προγράμματος περιήγησης και πύλες

Τα προγράμματα περιήγησης δεν μπορούν να συνδεθούν απευθείας σε δίκτυα peer-to-peer. Η Bitsocial το χειρίζεται αυτό με **πύλες HTTP** που αναμεταδίδουν δεδομένα μεταξύ του δικτύου P2P και των πελατών του προγράμματος περιήγησης. Αυτές οι πύλες:
...
Αυτό διατηρεί την εμπειρία του προγράμματος περιήγησης απρόσκοπτη, διατηρώντας παράλληλα την αποκεντρωμένη αρχιτεκτονική από κάτω.
