...
Captcha Canvas Challenge es un generador de captcha de imágenes independiente. Representa texto aleatorio en un lienzo HTML y devuelve la imagen resultante, que las comunidades pueden presentar a los autores como un desafío de spam.
