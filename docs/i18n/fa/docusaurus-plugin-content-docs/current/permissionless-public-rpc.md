...
در سطح سیم، اولین عرضه همچنان می‌تواند شکل JSON-RPC و حمل و نقل فعلی را حفظ کند، جایی که برای سازگاری مفید است. به عبارت دیگر: اسناد می‌توانند به صورت Bitsocial-Native باقی بمانند، حتی اگر دوره انتقال برخی از نام‌های متد سازگار محور یا درخواست شکل‌ها را در پشت صحنه نگه دارد.
...
برخی از پیاده‌سازی‌های اولیه ممکن است هنوز نام روش‌های سازگاری گرا را به صورت داخلی نشان دهند. این باید به عنوان یک جزئیات مهاجرت در نظر گرفته شود، نه به عنوان واژگان عمومی دائمی اسناد Bitsocial.
