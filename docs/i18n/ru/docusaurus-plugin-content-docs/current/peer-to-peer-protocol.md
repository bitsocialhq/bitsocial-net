...
description: Как Bitsocial использует адресацию с открытым ключом и одноранговую публикацию для предоставления бессерверных социальных сетей.
---
...
## Пользователи браузера и шлюзы

Браузеры не могут напрямую подключаться к одноранговым сетям. Bitsocial решает эту проблему с помощью **HTTP-шлюзов**, которые передают данные между P2P-сетью и клиентами браузера. Эти шлюзы:
...
Это обеспечивает бесперебойную работу браузера, сохраняя при этом децентрализованную архитектуру.
