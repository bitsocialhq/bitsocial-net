...
description: Як Bitsocial використовує адресацію відкритого ключа та одноранговий pubsub для надання безсерверних соціальних мереж.
---
...
## Користувачі браузера та шлюзи

Браузери не можуть безпосередньо приєднуватися до однорангових мереж. Bitsocial вирішує це за допомогою **HTTP-шлюзів**, які передають дані між мережею P2P і клієнтами браузера. Ці шлюзи:
...
Це забезпечує безперебійну роботу браузера, зберігаючи децентралізовану архітектуру.
