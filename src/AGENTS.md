...
- When changing React UI logic, run `bun run doctor` in addition to build, lint, and typecheck. When changing layout or interaction, verify desktop and mobile behavior with `agent-browser`.
