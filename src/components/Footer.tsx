...
export default function Footer() {
  return (
    <footer className="border-t border-silver-dark/20 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="font-display font-bold text-lg mb-4 chrome-text">Bitsocial</h3>
        ...
        <div className="pt-8 border-t border-silver-dark/20 text-center text-silver-mid text-sm">
          <p>Built for the decentralized web</p>
